...
const m$article = require('../modules/article.modules');
...
ArticleController.delete('/', userSession, async (req, res, next) => {
    const del = await m$article.deleteArticle(req.body);
